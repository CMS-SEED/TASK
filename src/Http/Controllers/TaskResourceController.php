<?php
namespace Cms_Framework_Seed\Task\Http\Controllers;

use App\Http\Controllers\ResourceController as BaseController;
use Cms_Framework_Seed\Task\Http\Requests\TaskRequest;
use Cms_Framework_Seed\Task\Interfaces\TaskRepositoryInterface;
use Cms_Framework_Seed\Task\Models\Task;
...
class TaskResourceController extends BaseController
{
    ...
    public function __construct(TaskRepositoryInterface $task)
    {
        ...
        $this->repository
            ...
            ->pushCriteria(\Cms_Framework_Seed\Task\Repositories\Criteria\TaskResourceCriteria::class);
    }
    ...
    public function index(TaskRequest $request)
    {
        ...
        if ($this->response->typeIs('json')) {
            ...
            $data      = $this->repository
                ->setPresenter(\Cms_Framework_Seed\Task\Repositories\Presenter\TaskListPresenter::class)
